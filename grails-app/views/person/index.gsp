...
<html>
	...
	<body>
		...
		<div id="page-body" role="main">
			<h1>Welcome to WeTheSauce</h1>
			<p>My name is ${name} and I have a Nickname:
<g:if test="${nickNames == true }">
<g:link action="person">Dre</g:link>
</g:if>
<g:elseif test="${nickNames == false}">
    False
</g:elseif></p>
